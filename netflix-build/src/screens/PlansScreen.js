        ...
        const docRef = await db
            ...
            docRef.onSnapshot(async (snap) => {
                ...
                if(sessionId) {
                    ...
                    const stripe = await loadStripe("pk_test_51IxZkRSHprHPK9Vw7TzV9FjLhX34arSFuvERJQu89u3OCbKrcBKu3TwvRGLg0GlAqXZGualcGKyWpWzw1rNkH3JS00IPIavKkP");
                ...
                return (
                    <div key={productId} className={`${isCurrentPackage && 'plansScreen-plan--disabled'} plansScreen-plan`}>
                        ...
                        <button onClick={() => 
                            ...
                            {isCurrentPackage ? 'Current Package' : 'Subscribed'}
                        </button>
                    </div>
                )
            })}            
